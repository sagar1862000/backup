...
export class DbService implements OnInit, OnChanges {
  ...
  // rooturi = 'http://192.168.3.119:8001/'; Deepanshu Api
  // rooturi = 'https://api.botshreyasi.com/';
  rooturi = '192.168.4.100:8080/' 
  ...
  token: any;
  public previousUrl: any = undefined;
  CurrentURL = '';
  mp: any = {};
  ...
  extractIDsData(data:any, id?:any): any {
  ...
  // getIDs(nodetype?:any, id?:any): any {
  //   if (id === null || id === undefined) {
  //     id = 'id';
  //   }
  //   const ids = [];
  ...
  extractCallId(data:any, call_id?:any): any {
  ...
  public showDialog(messsage:any, title?:any) {
  ...
  ConvertToFormData(obj:any, form:any, namespace:any) {
  ...
  SelectedCheckbox(obj:any, selected = 'selected', key = 'id'): any {
  ...
  SelectedWithComma(obj:any, key = 'id'): any {
  ...
  SelectedCheckboxWithComma(obj:any, key = 'id'): any {
    let selectedcheckbox = '';
    for (const i in obj) {
      if (obj[i]) {
        selectedcheckbox += obj[i][key] + ',';
  ...
  extractCallIDData(data:any, id?:any): any {
    if (id === null || id === undefined) {
      id = 'id';
    }
    const ids1 = [];
