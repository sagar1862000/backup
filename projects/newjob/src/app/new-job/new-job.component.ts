...
export class NewJobComponent implements OnInit {
  ...
  jobtitlesuggestion(): void {
    ...
    this.db.getdata('jobs/jobtitle-suggestion/', { job_title: this.myjob.job_title }, (response) => {
  ...
  joblist(): void {
    ...
    this.db.list('jobs/view-jobs/', {}, ((response): void => {
...
debugger;
  ...
  showJob(id): void {
    ...
    this.db.show('jobs/show-job/', id, (response): void => {
  ...
  getkeyskillssearch(): void {
    ...
    this.db.getdata('jobs/suggest-key-skills/', { tts: search }, (response) => {
  ...
  loadlocation(): void {
    ...
    this.locations = [];
    this.db.list('jobs/location/', null, (response): void => {
  ...
  loadinternationlocation(): void {
    ...
    this.locations = [];
    this.db.list('jobs/international-location/', null, (response) => {
  ...
  addNewJobSave(): void {
    ...
    if (true) {
      ...
      if (this.myjob.minimum_salary > this.myjob.maximum_salary) {
        ...
        this.db.store('jobs/create-job/', topost, (response): void => {
          $('#NextPageOrNot').appendTo('body').modal('show');
