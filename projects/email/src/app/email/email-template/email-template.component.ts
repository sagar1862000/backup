...
export class EmailTemplateComponent implements OnInit {
  ...
  constructor(public db: DbService, private router: Router , public emailDb:EmailServiceService) { }
  state = 'default';
  ...
  LoadTemplates(): void {
    debugger;
    this.emailDb.list('getemail/', {}, ((response): void => {
  ...
  private onActionDeleteClick(data: any) {
    if (confirm('Are you sure?')) {
      this.emailDb.destroy('email-templates/', data.id, ((response): void => {
