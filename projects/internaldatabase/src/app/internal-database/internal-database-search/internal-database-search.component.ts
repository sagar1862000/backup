...
export class InternalDatabaseSearchComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.andsearch !== null) {
      ...
      // this.andsearchArray = this.andsearch.split(',');
    }
    if (this.notsearch !== null) {
      ...
      // this.notsearchArray = this.notsearch.split(',');
    }

    // console.log('and : ', this.andsearchArray);
    // console.log('not : ', this.notsearchArray);
  ...
  // this.newChips[this.navItems.findIndex(nav => nav.column_name === columnName)] = '';
  ...
  inputData: { [key: string]: string[] } = {
    skill_set: ['Sample1'],
    qualification: ['Sample2'],
    current_designation: ['Sample3'],
    current_organization: ['Sample4'],
    functional_area: ['Sample5'],
    industry_type: ['Sample6'],
  };
  ...
  OnheaderSearchClickedAdvance() {
    ...
    let selected = {
      ...
      text_query_ANY: this.orsearchArray,
      text_query_ALL: this.andsearchArray,
      text_query_NOT: this.notsearchArray,
    ...
    this.internalDb.store('advanced_query', selected, (response): void => {
      debugger;
  ...
  OnheaderSearchClickedBasic() {
    ...
    this.internalDb.store('boolean_query', selected, (response): void => {
      debugger;
      this.datas = response.results;
      this.tableName = response.table_name;
      this.PrimaryColumns = response.primary_column_names;
  ...
  getData() {
    if (this.searchdata == 'boolean') {
      ...
      this.internalDb.getdata('boolean_query', selected, (response): void => {
        debugger;
        this.datas = response.results;
        this.tableName = response.table_name;
        this.PrimaryColumns = response.primary_column_names;
        ...
        debugger;
        this.counts = 1026; //response.count;
        console.log('myquery : ', this.query);
      ...
      this.internalDb.getdata('advanced_query', selected, (response): void => {
        debugger;
        this.datas = response.results;
        this.tableName = response.table_name;
        this.PrimaryColumns = response.primary_column_names;
  ...
  OnSearchClick() {
    ...
    // console.log('h2');
    // console.log('Searched Data : ', SearchData.obj);

    this.internalDb.store('columnar_filters_query', SearchData, (response): void => {
      debugger;
      this.res = response;
      // console.log('Search Data : ',this.res);
